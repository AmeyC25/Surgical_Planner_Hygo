...
if uploaded_file:
    ...
    if isinstance(segmentation_result, str):  # Error handling
        ...
        Make the thing as crisp and to the point as possible, using medical terminology and ensuring clarity for healthcare professionals.
        Ensure the report is concise, informative, and suitable for clinical use.   
        Note that this is just a report of the MRI, and nothing else. THis is to passed along with history and other data to another LLM for diagnosis.
        """
