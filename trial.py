...
# Initialize OpenAI client with the newer API
client = OpenAI(
...
# **Streamlit UI**
st.title("🧠 HYGO AI - Advanced MRI/CT Clinical Analyzer & Report Generator")
...
if uploaded_file:
    ...
    st.write("🔍 Performing Enhanced Multi-class Segmentation with HYGO AI...")
    model = load_model()
    ...
    if isinstance(segmentation_result, str):  # Error handling
        ...
        st.write("✍️ Generating Comprehensive Clinical Report with HYGO AI...")
        prompt = f"""
        You are an AI medical assistant developed by HYGO AI, a leading medical technology startup specializing in advanced medical imaging and clinical analysis.
        ...
        Please include a footer mentioning that this report was generated using HYGO AI's advanced medical imaging technology.
        """
        ...
        try:
            ...
            st.subheader("📜 Comprehensive Clinical Report - HYGO AI")
            st.write(report)
            
            # Add HYGO AI branding footer
            st.markdown("---")
